...
function deleteMovie(movie_id){
	$('#movie_checkbox_'+movie_id).attr("checked",true);
                ...
                $.colorbox({
                    ...
                    onComplete: function(){
                        $('.confirm_yes').click(function(e){                       	
                            e.preventDefault();
                            deleteMulti($('input[name=row_sel]:checked'));
                    ...
                    onComplete: function(){
                        $('.confirm_yes').click(function(e){
                        	...
                        	if (to_delete.length>0){
                        		$.post('ajax/movies_delete.php',{
                        			movie_ids: to_delete.join(',')
                        		},function(data){
...
gebo_galery_table = {
    init: function() {
       $('#dt_gal').dataTable({
			...
			"bStateSave": false,
            "aaSorting": [],
            "sAjaxSource": "ajax/movies_paginate.php",
