...
if (isset($addcategory) && isset($category)){
    $errors = $show->validateCategory($category);
    if (!count($errors)){
        ...
        <form action="index.php" method="post" class="form-horizontal well">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="hidden" name="menu" value="tv_categories" />
            ...
            if (count($categories)){
                ...
                foreach($categories as $key=>$val){
                    ...
                    print("    <span class='span2 well' id='tag$key'>
                                <a href='javascript:void(0);' onclick='deleteTVtag($key)' title='Delete'><img src='img/gCons/fire.png' style='border:0px;' /></a> {$val['name']}
                            </span>");
